...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box">
                <h4 class="header-title mt-0 mb-3">New Language</h4>
                @if ($errors->any())
                ...
                <form method="POST" action="{{ url('languages') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input name="name" type="text" id="geo_name" parsley-trigger="change" required="" class="form-control" value="">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label" for="geo_slug">Slug*</label>
                        <div class="col-md-10">
                            <input name="slug" type="text" id="geo_slug" parsley-trigger="change" required="" class="form-control" value="">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label" for="geo_slug">Ad title prefix for Outbrain*</label>
                        <div class="col-md-10">
                            <input name="ad_title_prefix_outbrain" type="text" id="ad_title_prefix_outbrain" parsley-trigger="change" class="form-control" value="">
                        </div>
                    </div>
                    <div class="form-group row">
