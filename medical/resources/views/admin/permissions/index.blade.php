...
@section('content')
                ...
                <table class="table table-hover mb-0">
                    ...
                    @foreach ($permissions as $permission)
                        <tr>
                            ...
                            <td>{{ date_format($permission->created_at, 'M jS Y') }}</td>
                            <td>
                                <form action="{{ route('permissions.destroy', $permission->id) }}" method="POST">
                                    <a href="{{ route('permissions.show', $permission->id) }}" title="View">
    ...
    <script type="text/javascript">
        jQuery(".confirm_delete").click(function(){
            if(confirm("Are you sure want delete this Permission? This action cannot be undone.")){
                //console.log('true');
                return true;
            } else {
                //console.log('false');
